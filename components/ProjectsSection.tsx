...
const projects = [
  ...
  },
  {
    ...
    description:
      "The Admin Dashboard is a custom-built content management system for the products sold on Trillion Troves. Interesed users can also create their own stores for use on a frontend of their choice. Features include Next, Tailwind, Prisma, MySQL, ReCharts, and, Stripe.",
